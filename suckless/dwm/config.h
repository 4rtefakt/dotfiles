...
static const char col_cyan[]        = "#47e10c";
...
static const char *reboot[]   = { "dmenu_reboot", NULL };
static const char *lockscr[]  = { "slock", NULL };
static const char *prtscr[]   = { "scrot" , "-e", "mv $f ~/screenshots" };

static const char *surf[]     = { "tabbed", "surf", "-e", NULL };
static const char *discord[]  = { "st", "-e", "6cord", NULL };
static const char *shuffle[]  = { "mpv", "/home/kore/Music/*", "--shuffle", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,						XK_c,		spawn,			{.v = discord } },
	{ MODKEY,						XK_s,		spawn,			{.v = shuffle } },
	{ MODKEY,						XK_m,		spawn,			{.v = music } },

/*
	{ MODKEY|ShiftMask,				XK_Down,   moveresize,     	{.v = (int []){   0,  25,   0,   0 }}},
	{ MODKEY|ShiftMask,				XK_Up,     moveresize,     	{.v = (int []){   0, -25,   0,   0 }}},
	{ MODKEY|ShiftMask,				XK_Right,  moveresize,     	{.v = (int []){  25,   0,   0,   0 }}},
	{ MODKEY|ShiftMask,				XK_Left,   moveresize,     	{.v = (int []){ -25,   0,   0,   0 }}},
